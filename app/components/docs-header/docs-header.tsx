import { Link, useNavigate } from "react-bridging";
...
function LogoLink() {
  ...
  return (
    ...
    >
      <svg
        aria-label="React Bridging logo, nine dots in an upward triangle (one on top, two in the middle, three on the bottom) with a path of three highlighted and connected from top to bottom, next to the text React Bridging"
        className="h-14 w-40"
      >
...
function ExternalLinks() {
  return (
    <div className="flex items-center gap-4">
      <HeaderSvgLink
        href="https://github.com/khulnasoft/react-bridging"
        svgId="github"
