import type { HeadersArgs } from "react-bridging";
  ...
  let mainLinks = [
    {
      ...
      description: (
        <div>
          We recommend you use React Bridging as your framework. Check out the{" "}
    ...
    {
      title: "Upgrade from React Bridging v6",
      description: (
        <div>
    ...
    },
    {
      ...
      description: (
        <div>
          React Bridging can be used maximally as a framework or minimally as a
  ...
  return (
    <>
      <div className="max-w-[40rem]">
        <h1 className="text-xl font-bold">React Bridging v7 Pre-release</h1>
        <p className="mb-2">
...
function V6() {
  let mainLinks = [
    ...
    },
    {
      title: "I'm New!",
      description:
        "Start with the tutorial. It will quickly introduce you to the primary features of React Bridging: from configuring routes, to loading and mutating data, to pending and optimistic UI.",
      slug: "start/tutorial",
      className: "text-red-brand",
      // prettier-ignore
      svg: (
    ...
    },
    {
      title: "I'm Stuck!",
      description:
        "Running into a problem? Chances are you're not the first! Explore common questions about React Bridging v6.",
      slug: "start/faq",
      className: "text-yellow-600 dark:text-yellow-brand",
      // prettier-ignore
      svg: (
