import { Await, Link } from "react-bridging";
...
export const meta: Route.MetaFunction = ({ matches }) => {
  ...
  return [
    { title: "React Bridging Official Documentation" },
...
const quicklinks: QuickLink[] = [
  ...
  },
  {
    icon: "github-outline",
    title: "GitHub",
    to: "https://github.com/khulnasoft/react-bridging",
  },
  {
...
const highlights: Highlight[] = [
  {
    ...
    title: "Non-breaking",
    description:
      "Upgrading from v6 to v7 is a non-breaking upgrade. Keep using React Bridging the same way you already do.",
  },
  {
    icon: "box",
...
const adventures: Adventure[] = [
  {
    title: "I'm new!",
    description: "Learn how to get the most out of React Bridging",
    linkText: "Start Here",
    linkTo: "home",
  },
  {
  ...
  },
  {
    ...
    description:
      "Learn how to adopt the new framework features in your existing React Bridging app",
        ...
        <h1>
          <picture className="aspect-[32/5] w-[360px] md:w-[480px] lg:w-[640px] 2xl:w-[960px]">
            ...
            <img
              ...
              alt="React Bridging logo, nine dots in an upward triangle (one on top, two in the middle, three on the bottom) with a path of three highlighted and connected from top to bottom, next to the text React Bridging"
